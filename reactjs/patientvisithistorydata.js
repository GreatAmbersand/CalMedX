   ...
   'patientVisitHistories': [
	 {
	  ...
	  brief: 'Patient visited primary care physician on 6/30/2005 2:15:00 PM for Chief Complaint: mild occasional lightheadedness',
	  cc: 's:a 33 year old female crystallographer presents with mild spells of vertigo, mild headaches particularly at the back of the head and in the morning x 2 weeks. pt also reports chronic mild occasional lightheadedness.',
	  vitals:  'Height 160 cm, Weight 53.8 kg, Temperature 37.3 C, Pulse 76, SystolicBP 146, DiastolicBP 93, Respiration 15, Heart = 2/6 systolic murmur at base of heart, Chest = clear to auscultation B/L, no rales or wheezing, Extremities = no edema or clubbing, Heart = normal S1, S2, RRR a:Hypertension p:performed E/M Level 2 (established patient) - Completed, and prescribed Hydrochlorothiazide - 50 mg po qd, and ordered Cholesterol.'
	 },
	 {
	  physician:'Shelley A Lawson, RPh',
	  dateString:'2005-07-01T23:44:00Z',
      brief:'Patient visited pharmacy on 7/1/2005 6:44:00 PM for OngoingCare',
	  cc:'',
	  vitals: ''
	 },			
	 {
      ...
      brief:'Patient visited medical lab on 7/5/2005 9:54:00 AM for OngoingCare',
	  cc:'',
	  vitals: ''
	 },			
	 {
      ...
      brief:'Patient visited primary care physician on 10/7/2005 10:45:00 AM for Wellness',
	  cc:'s:33 yr old female crystallographer presents today for routine exam. patient reports no acute problems. Patient reports that she never drinks alcohol. she denies smoking. ',
	 ...
	 },			
	 {
      ...
      brief:'Patient visited medical lab on 10/12/2005 3:33:00 PM for OngoingCare',
	  notes:''
	 },			
   ]
};
